...
namespace Moritz.Symbols
{
    ...
    internal class TieTemplate : DrawObject
    {
        ...
        /// <param name="p3"></param>
        /// <param name="p4"></param>
        public TieTemplate(Point p1, Point p2, Point p3, Point p4, double gap, bool isOver)
        {
            _p1 = p1;
            _p2 = p2;
            _p3 = p3;
        ...
        /// <param name="c3"></param>
        /// <param name="p3"></param>
        public TieTemplate(Point p1, Point c1, Point c2, Point p2, Point c3, Point p3, double gap, bool isOver)
        {
            _p1 = p1;
            _p2 = p2;
            _p3 = p3;
            ...
            Metrics = new SlurTieMetrics(CSSObjectClass.tieTemplate, gap, p1.X, p1.Y, p3.X, isOver);
        }
